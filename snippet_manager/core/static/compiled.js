...
function displayResults(key) {
    ...
    <div id="snippet${ key.pk}" class="card bg-transparent shadow-sm">
            ...
            <div class="card-body">
            <p class="card-text">${key.user_username} | Added on: ${key.date} | Copied ${key.num_times_copied} times</p>
...
(function (global){
/* PrismJS 1.16.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash+ruby+markup-templating+java+php+sql+python&plugins=line-numbers+toolbar+copy-to-clipboard */
...
},{"clipboard":3}],3:[function(require,module,exports){
/*!
 * clipboard.js v2.0.4
